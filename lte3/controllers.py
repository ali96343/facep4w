...
def index3():
    ...
    if findex30.accepted:
        ...
        return put_json_messages('accepted: ' + str( findex30.form_name ))
...
def index2():
    ...
    if findex20.accepted:
        ...
        return put_json_messages('accepted: ' + str( findex20.form_name ))
    ...
    if findex21.accepted:
        ...
        return put_json_messages('accepted: ' + str( findex21.form_name ))
...
def iframe():
    ...
    if fiframe0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fiframe0.form_name ))
...
def starter():
    ...
    if fstarter0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fstarter0.form_name ))
...
def widgets():
    ...
    if fwidgets0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets0.form_name ))
    ...
    if fwidgets1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets1.form_name ))
    ...
    if fwidgets2.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets2.form_name ))
    ...
    if fwidgets3.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets3.form_name ))
    ...
    if fwidgets4.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets4.form_name ))
    ...
    if fwidgets5.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets5.form_name ))
    ...
    if fwidgets6.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets6.form_name ))
    ...
    if fwidgets7.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets7.form_name ))
    ...
    if fwidgets8.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets8.form_name ))
    ...
    if fwidgets9.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets9.form_name ))
    ...
    if fwidgets10.accepted:
        ...
        return put_json_messages('accepted: ' + str( fwidgets10.form_name ))
...
def topXnav():
    ...
    if ftopXnav0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ftopXnav0.form_name ))
...
def topXnavXsidebar():
    ...
    if ftopXnavXsidebar0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ftopXnavXsidebar0.form_name ))
...
def boxed():
    ...
    if fboxed0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fboxed0.form_name ))
    elif fboxed0.errors:
...
def fixedXsidebar():
    ...
    if ffixedXsidebar0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ffixedXsidebar0.form_name ))
...
def fixedXsidebarXcustom():
    ...
    if ffixedXsidebarXcustom0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ffixedXsidebarXcustom0.form_name ))
...
def fixedXtopnav():
    ...
    if ffixedXtopnav0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ffixedXtopnav0.form_name ))
...
def fixedXfooter():
    ...
    if ffixedXfooter0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ffixedXfooter0.form_name ))
...
def collapsedXsidebar():
    ...
    if fcollapsedXsidebar0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fcollapsedXsidebar0.form_name ))
...
def chartjs():
    ...
    if fchartjs0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fchartjs0.form_name ))
...
def flot():
    ...
    if fflot0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fflot0.form_name ))
    elif fflot0.errors:
...
def inline():
    ...
    if finline0.accepted:
        ...
        return put_json_messages('accepted: ' + str( finline0.form_name ))
...
def uplot():
    ...
    if fuplot0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fuplot0.form_name ))
    elif fuplot0.errors:
...
def general():
    ...
    if fgeneral0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fgeneral0.form_name ))
...
def icons():
    ...
    if ficons0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ficons0.form_name ))
    elif ficons0.errors:
...
def buttons():
    ...
    if fbuttons0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fbuttons0.form_name ))
...
def sliders():
    ...
    if fsliders0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fsliders0.form_name ))
...
def navbar():
    ...
    if fnavbar0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar0.form_name ))
    ...
    if fnavbar1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar1.form_name ))
    ...
    if fnavbar2.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar2.form_name ))
    ...
    if fnavbar3.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar3.form_name ))
    ...
    if fnavbar4.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar4.form_name ))
    ...
    if fnavbar5.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar5.form_name ))
    ...
    if fnavbar6.accepted:
        ...
        return put_json_messages('accepted: ' + str( fnavbar6.form_name ))
...
def timeline():
    ...
    if ftimeline0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ftimeline0.form_name ))
...
def ribbons():
    ...
    if fribbons0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fribbons0.form_name ))
...
def advanced():
    ...
    if fadvanced0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fadvanced0.form_name ))
...
def editors():
    ...
    if feditors0.accepted:
        ...
        return put_json_messages('accepted: ' + str( feditors0.form_name ))
...
def validation():
    ...
    if fvalidation0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fvalidation0.form_name ))
    ...
    if fvalidation1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fvalidation1.form_name ))
...
def simple():
    ...
    if fsimple0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fsimple0.form_name ))
...
def data():
    ...
    if fdata0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fdata0.form_name ))
    elif fdata0.errors:
...
def jsgrid():
    ...
    if fjsgrid0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fjsgrid0.form_name ))
...
def gallery():
    ...
    if fgallery0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fgallery0.form_name ))
...
def mailbox():
    ...
    if fmailbox0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fmailbox0.form_name ))
...
def compose():
    ...
    if fcompose0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fcompose0.form_name ))
...
def readXmail():
    ...
    if freadXmail0.accepted:
        ...
        return put_json_messages('accepted: ' + str( freadXmail0.form_name ))
...
def invoice():
    ...
    if finvoice0.accepted:
        ...
        return put_json_messages('accepted: ' + str( finvoice0.form_name ))
...
def profile():
    ...
    if fprofile0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprofile0.form_name ))
    ...
    if fprofile1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprofile1.form_name ))
    ...
    if fprofile2.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprofile2.form_name ))
...
def eXcommerce():
    ...
    if feXcommerce0.accepted:
        ...
        return put_json_messages('accepted: ' + str( feXcommerce0.form_name ))
...
def projects():
    ...
    if fprojects0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprojects0.form_name ))
...
def projectXadd():
    ...
    if fprojectXadd0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprojectXadd0.form_name ))
...
def projectXedit():
    ...
    if fprojectXedit0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprojectXedit0.form_name ))
...
def projectXdetail():
    ...
    if fprojectXdetail0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fprojectXdetail0.form_name ))
...
def contacts():
    ...
    if fcontacts0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fcontacts0.form_name ))
...
def faq():
    ...
    if ffaq0.accepted:
        ...
        return put_json_messages('accepted: ' + str( ffaq0.form_name ))
    elif ffaq0.errors:
...
def contactXus():
    ...
    if fcontactXus0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fcontactXus0.form_name ))
...
def recoverXpassword():
    ...
    if frecoverXpassword0.accepted:
        ...
        return put_json_messages('accepted: ' + str( frecoverXpassword0.form_name ))
...
def loginXv2():
    ...
    if floginXv20.accepted:
        ...
        return put_json_messages('accepted: ' + str( floginXv20.form_name ))
...
def registerXv2():
    ...
    if fregisterXv20.accepted:
        ...
        return put_json_messages('accepted: ' + str( fregisterXv20.form_name ))
...
def forgotXpasswordXv2():
    ...
    if fforgotXpasswordXv20.accepted:
        ...
        return put_json_messages('accepted: ' + str( fforgotXpasswordXv20.form_name ))
...
def recoverXpasswordXv2():
    ...
    if frecoverXpasswordXv20.accepted:
        ...
        return put_json_messages('accepted: ' + str( frecoverXpasswordXv20.form_name ))
...
def lockscreen():
    ...
    if flockscreen0.accepted:
        ...
        return put_json_messages('accepted: ' + str( flockscreen0.form_name ))
...
def legacyXuserXmenu():
    ...
    if flegacyXuserXmenu0.accepted:
        ...
        return put_json_messages('accepted: ' + str( flegacyXuserXmenu0.form_name ))
...
def languageXmenu():
    ...
    if flanguageXmenu0.accepted:
        ...
        return put_json_messages('accepted: ' + str( flanguageXmenu0.form_name ))
...
def X500():
    ...
    if fX5000.accepted:
        ...
        return put_json_messages('accepted: ' + str( fX5000.form_name ))
    elif fX5000.errors:
    ...
    if fX5001.accepted:
        ...
        return put_json_messages('accepted: ' + str( fX5001.form_name ))
    elif fX5001.errors:
...
def pace():
    ...
    if fpace0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fpace0.form_name ))
    elif fpace0.errors:
...
def enhanced():
    ...
    if fenhanced0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fenhanced0.form_name ))
    ...
    if fenhanced1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fenhanced1.form_name ))
...
def enhancedXresults():
    ...
    if fenhancedXresults0.accepted:
        ...
        return put_json_messages('accepted: ' + str( fenhancedXresults0.form_name ))
    ...
    if fenhancedXresults1.accepted:
        ...
        return put_json_messages('accepted: ' + str( fenhancedXresults1.form_name ))
