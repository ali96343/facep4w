                    ...
                    this.prototype.Emitter = p, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                        ...
                        error: function(e, t) {
                            if (e.previewElement) {
                                ...
                                var n, i = w(e.previewElement.querySelectorAll("[data-dz-errormessage]"));
                                try {
                                    for (i.s(); !(n = i.n()).done;) {
                        ...
                        uploadprogress: function(e, t) {
                            if (e.previewElement) {
                                var n, i = w(e.previewElement.querySelectorAll("[data-dz-uploadprogress]"));
                                try {
                                    for (i.s(); !(n = i.n()).done;) {
                                        var r = n.value;
    ...
    h.initClass(), h.version = "5.7.2", h.options = {}, h.optionsForElement = function(e) {
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
            if ("classList" in document.createElement("a")) {
                var t, n = w(h.blacklistedBrowsers);
                try {
                    for (n.s(); !(t = n.n()).done;) {
        ...
        for (var t = atob(e.split(",")[1]), n = e.split(",")[0].split(":")[1].split(";")[0], i = new ArrayBuffer(t.length), r = new Uint8Array(i), a = 0, o = t.length, s = 0 <= o; s ? a <= o : o <= a; s ? a++ : a--) r[a] = t.charCodeAt(a);
        return new Blob([i], {
            type: n
        })
    };
    ...
    h.createElement = function(e) {
        ...
        if (e instanceof Array) {
            ...
            try {
                var r, a = w(e);
                try {
                    for (a.s(); !(r = a.n()).done;) n = r.value, i.push(this.getElement(n, t))
                } catch (e) {
                    a.e(e)
                } finally {
                    a.f()
            ...
            i = [];
            var o, s = w(document.querySelectorAll(e));
            try {
