! function(t, e) {
    ...
    function oe(t) {
        for (var e in t) ee(o = e) || W('Unknown parameter "'.concat(o, '"')), t.toast && (n = e, -1 !== se.indexOf(n) && W('The parameter "'.concat(n, '" is incompatible with toasts'))), ne(n = e) && v(n, ne(n));
        var n, o
    }
    var ie = {},
        re = {
