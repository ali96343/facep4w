...
def before_request():
    bad_path= '/flat/static/tte/flat/static/tte/'
    bad_root='/flat/flat/'
    if bottle.request.environ["PATH_INFO"].startswith(bad_path):
        bottle.request.environ["PATH_INFO"]= bottle.request.environ["PATH_INFO"].replace( '/flat/static/tte', '', 1)
        print ( f'before_request:    /flat: goto {bottle.request.environ["PATH_INFO"]}' )
    elif bottle.request.environ["PATH_INFO"].startswith(bad_root):
        bottle.request.environ["PATH_INFO"]= bottle.request.environ["PATH_INFO"].replace( '/flat', '', 1)
        print ( f'before_request:    /flat: goto {bottle.request.environ["PATH_INFO"]}' )
