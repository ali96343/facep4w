! function() {
    ...
    function q(t, s) {
        ...
        if (a.language) {
            ...
            if (a.language !== o && (r[a.language] ? e = a.language : void 0 === r[e = a.language.split("-")[0]] && (e = !1)), delete a.language, e) {
                ...
                c = Object.assign({
                    format: j,
                    weekStart: K
                }, r[$]), o !== $ && Object.assign(c, r[o]), n.locale = c, d === t.format && (d = n.format = c.format), m === t.weekStart && (m = n.weekStart = c.weekStart, n.weekEnd = R(c.weekStart))
            }
        }
        if (a.format) {
        ...
        if (void 0 !== a.weekStart) {
            ...
            isNaN(e) || (m = n.weekStart = e, n.weekEnd = R(e)), delete a.weekStart
        }
        if (a.daysOfWeekDisabled && (n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(P, []), delete a.daysOfWeekDisabled), a.daysOfWeekHighlighted && (n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(P, []), delete a.daysOfWeekHighlighted), void 0 !== a.maxNumberOfDates) {
        ...
        let y = u;
        void 0 !== a.maxView && (y = I(a.maxView, u), delete a.maxView), y !== u && (u = n.maxView = y);
        let D = p;
        if (void 0 !== a.startView && (D = I(a.startView, D), delete a.startView), (D = u < D ? u : D) !== p && (n.startView = D), a.prevArrow) {
        ...
        performBeforeHook(e, t, s) {
            ...
            if (a) {
                ...
                a.content && function(e, t) {
                    H(e), t instanceof DocumentFragment ? e.appendChild(t) : "string" == typeof t ? e.appendChild(W(t)) : "function" == typeof t.forEach && t.forEach(t => {
                        e.appendChild(t)
                    })
                }(e, a.content)
            }
    ...
    class G extends X {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (T(this.dow), this.calendarWeeks && T(this.calendarWeeks.dow)) : (Y(this.dow), this.calendarWeeks && Y(this.calendarWeeks.dow))), i && Array.from(this.dow.children).forEach((e, t) => {
    ...
    function ae(t, i) {
        if (void 0 !== i.title && (i.title ? (t.controls.title.textContent = i.title, T(t.controls.title)) : (t.controls.title.textContent = "", Y(t.controls.title))), i.prevArrow) {
            const e = t.controls.prevBtn;
            H(e), i.prevArrow.forEach(t => {
                e.appendChild(t.cloneNode(!0))
            })
        }
        if (i.nextArrow) {
            const e = t.controls.nextBtn;
            H(e), i.nextArrow.forEach(t => {
                e.appendChild(t.cloneNode(!0))
            })
        }
        if (i.locale && (t.controls.todayBtn.textContent = i.locale.today, t.controls.clearBtn.textContent = i.locale.clear), void 0 !== i.todayBtn && (i.todayBtn ? T(t.controls.todayBtn) : Y(t.controls.todayBtn)), e(i, "minDate") || e(i, "maxDate")) {
            const {
                minDate: e,
                maxDate: i
            } = t.datepicker.config;
        ...
        void 0 !== i.clearBtn && (i.clearBtn ? T(t.controls.clearBtn) : Y(t.controls.clearBtn))
    }
    ...
    class oe {
        constructor(e) {
            ...
            i.classList.add(`datepicker-${p}`), ae(this, e.config), this.viewDate = ne(e), F(e, [
        ...
        show() {
            ...
            if (!e.inline) {
                ...
                t !== de(e.config.container) ? this.element.dir = t : this.element.dir && this.element.removeAttribute("dir"), this.place(), e.config.disableTouchKeyboard && e.inputField.blur()
            }
            ee(e, "show")
        }
        hide() {
    ...
    class ue {
        ...
        setDate(...e) {
            ...
            d && (d.toString() !== this.dates.toString() ? (this.dates = d, s.render ? (this.picker.update(), this.refresh()) : this.refresh("input"), ee(this, "changeDate")) : this.refresh("input"), s.render && s.autohide && this.hide())
        }
        update(e) {
        ...
        refresh(e) {
            "input" !== e && this.picker.render(), this.inline || "picker" === e || (this.inputField.value = le(this.dates, this.config))
        }
        enterEditMode() {
