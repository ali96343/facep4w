    ...
    if flock0.accepted:
        ...
        if len ( flock0_f0 ):
            ...
            if not id_dflock0 is None:
                dflock0_rows = db.dflock0(id_dflock0 )

                if not dflock0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{flock0.vars.f0}\" into db.dflock0.f0, id = {id_dflock0}' )
                         print(f"     found db.dflock0.f0: \"{dflock0_rows.f0}\", id = {id_dflock0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(flock0_f0)=0, not inserted")  
    ...
    if fmodals1.accepted:
        ...
        if len ( fmodals1_f0 ):
            ...
            if not id_dfmodals1 is None:
                dfmodals1_rows = db.dfmodals1(id_dfmodals1 )

                if not dfmodals1_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fmodals1.vars.f0}\" into db.dfmodals1.f0, id = {id_dfmodals1}' )
                         print(f"     found db.dfmodals1.f0: \"{dfmodals1_rows.f0}\", id = {id_dfmodals1}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fmodals1_f0)=0, not inserted")  
    ...
    if fmodals2.accepted:
        ...
        if len ( fmodals2_f0 ):
            ...
            if not id_dfmodals2 is None:
                dfmodals2_rows = db.dfmodals2(id_dfmodals2 )

                if not dfmodals2_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fmodals2.vars.f0}\" into db.dfmodals2.f0, id = {id_dfmodals2}' )
                         print(f"     found db.dfmodals2.f0: \"{dfmodals2_rows.f0}\", id = {id_dfmodals2}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fmodals2_f0)=0, not inserted")  
    ...
    if fsignXup0.accepted:
        ...
        if len ( fsignXup0_f0 ):
            ...
            if not id_dfsignXup0 is None:
                dfsignXup0_rows = db.dfsignXup0(id_dfsignXup0 )

                if not dfsignXup0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fsignXup0.vars.f0}\" into db.dfsignXup0.f0, id = {id_dfsignXup0}' )
                         print(f"     found db.dfsignXup0.f0: \"{dfsignXup0_rows.f0}\", id = {id_dfsignXup0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fsignXup0_f0)=0, not inserted")  
    ...
    if fsignXin0.accepted:
        ...
        if len ( fsignXin0_f0 ):
            ...
            if not id_dfsignXin0 is None:
                dfsignXin0_rows = db.dfsignXin0(id_dfsignXin0 )

                if not dfsignXin0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fsignXin0.vars.f0}\" into db.dfsignXin0.f0, id = {id_dfsignXin0}' )
                         print(f"     found db.dfsignXin0.f0: \"{dfsignXin0_rows.f0}\", id = {id_dfsignXin0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fsignXin0_f0)=0, not inserted")  
    ...
    if fsettings0.accepted:
        ...
        if len ( fsettings0_f0 ):
            ...
            if not id_dfsettings0 is None:
                dfsettings0_rows = db.dfsettings0(id_dfsettings0 )

                if not dfsettings0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fsettings0.vars.f0}\" into db.dfsettings0.f0, id = {id_dfsettings0}' )
                         print(f"     found db.dfsettings0.f0: \"{dfsettings0_rows.f0}\", id = {id_dfsettings0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fsettings0_f0)=0, not inserted")  
    ...
    if fsettings1.accepted:
        ...
        if len ( fsettings1_f0 ):
            ...
            if not id_dfsettings1 is None:
                dfsettings1_rows = db.dfsettings1(id_dfsettings1 )

                if not dfsettings1_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fsettings1.vars.f0}\" into db.dfsettings1.f0, id = {id_dfsettings1}' )
                         print(f"     found db.dfsettings1.f0: \"{dfsettings1_rows.f0}\", id = {id_dfsettings1}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fsettings1_f0)=0, not inserted")  
    ...
    if fdashboard0.accepted:
        ...
        if len ( fdashboard0_f0 ):
            ...
            if not id_dfdashboard0 is None:
                dfdashboard0_rows = db.dfdashboard0(id_dfdashboard0 )

                if not dfdashboard0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fdashboard0.vars.f0}\" into db.dfdashboard0.f0, id = {id_dfdashboard0}' )
                         print(f"     found db.dfdashboard0.f0: \"{dfdashboard0_rows.f0}\", id = {id_dfdashboard0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fdashboard0_f0)=0, not inserted")  
    ...
    if ftypography0.accepted:
        ...
        if len ( ftypography0_f0 ):
            ...
            if not id_dftypography0 is None:
                dftypography0_rows = db.dftypography0(id_dftypography0 )

                if not dftypography0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{ftypography0.vars.f0}\" into db.dftypography0.f0, id = {id_dftypography0}' )
                         print(f"     found db.dftypography0.f0: \"{dftypography0_rows.f0}\", id = {id_dftypography0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(ftypography0_f0)=0, not inserted")  
    ...
    if ftransactions0.accepted:
        ...
        if len ( ftransactions0_f0 ):
            ...
            if not id_dftransactions0 is None:
                dftransactions0_rows = db.dftransactions0(id_dftransactions0 )

                if not dftransactions0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{ftransactions0.vars.f0}\" into db.dftransactions0.f0, id = {id_dftransactions0}' )
                         print(f"     found db.dftransactions0.f0: \"{dftransactions0_rows.f0}\", id = {id_dftransactions0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(ftransactions0_f0)=0, not inserted")  
    ...
    if fnotifications0.accepted:
        ...
        if len ( fnotifications0_f0 ):
            ...
            if not id_dfnotifications0 is None:
                dfnotifications0_rows = db.dfnotifications0(id_dfnotifications0 )

                if not dfnotifications0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fnotifications0.vars.f0}\" into db.dfnotifications0.f0, id = {id_dfnotifications0}' )
                         print(f"     found db.dfnotifications0.f0: \"{dfnotifications0_rows.f0}\", id = {id_dfnotifications0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fnotifications0_f0)=0, not inserted")  
    ...
    if fresetXpassword0.accepted:
        ...
        if len ( fresetXpassword0_f0 ):
            ...
            if not id_dfresetXpassword0 is None:
                dfresetXpassword0_rows = db.dfresetXpassword0(id_dfresetXpassword0 )

                if not dfresetXpassword0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fresetXpassword0.vars.f0}\" into db.dfresetXpassword0.f0, id = {id_dfresetXpassword0}' )
                         print(f"     found db.dfresetXpassword0.f0: \"{dfresetXpassword0_rows.f0}\", id = {id_dfresetXpassword0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fresetXpassword0_f0)=0, not inserted")  
    ...
    if fbootstrapXtables0.accepted:
        ...
        if len ( fbootstrapXtables0_f0 ):
            ...
            if not id_dfbootstrapXtables0 is None:
                dfbootstrapXtables0_rows = db.dfbootstrapXtables0(id_dfbootstrapXtables0 )

                if not dfbootstrapXtables0_rows is None:
                    if Glb['debug'] == True:
                         print(f"app: {Glb['my_app_name']}")
                         print(f'     inserted: \"{fbootstrapXtables0.vars.f0}\" into db.dfbootstrapXtables0.f0, id = {id_dfbootstrapXtables0}' )
                         print(f"     found db.dfbootstrapXtables0.f0: \"{dfbootstrapXtables0_rows.f0}\", id = {id_dfbootstrapXtables0}" )
                         print ()
        else:
            if Glb['debug'] == True:
                print("app:",Glb['my_app_name'])
                print(f"     len(fbootstrapXtables0_f0)=0, not inserted")  
